                    ...
                    <div class="header-widget">
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14">
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i
                                    class="la la-phone mr-1"></i><a href="tel:00123456789">[tel. number]</a></li>
                            <li class="d-flex align-items-center"><i class="la la-envelope-o mr-1"></i><a
                                    href="mailto:contact@aduca.com">[email address]</a></li>
                        </ul>
                    ...
                    <div class="col-lg-10">
                        <div class="menu-wrapper">
                            ...
                            <nav class="main-menu">
                                <ul>
                                    <li>
                                        <a href="#home-section">Home<i class="fs-12"></i></a>
                                    </li>
                                    <li>
                                        <a href="#categories-section">Categories<i class="fs-12"></i></a>
