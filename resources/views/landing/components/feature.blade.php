        ...
        <div class="row feature-content-wrap">
            <div class="col-lg-4 responsive-column">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Travel You Can Trust</h3>
                    <p class="info__text">Unlock a world of insights as our app unveils heartfelt testimonials,
                        guiding you through the experiences of those who have journeyed with us.
                    </p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Exploring Made Easy</h3>
                    <p class="info__text">Book spontaneously, avoid queues, and benefit from complimentary
                        cancellations for a more convenient and flexible exploration experience.
                    </p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    <div class="info-overlay"></div>
                    <div class="icon-element mx-auto shadow-sm">
                        <svg width="40px" height="40px" viewBox="0 0 1024 1024" class="icon"
                    ...
                    <h3 class="info__title">Just For You</h3>
                    <p class="info__text">Indulge in a travel experience crafted exclusively for you, seamlessly
                        blending your interests, preferences, and must-see destinations.
                    </p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
