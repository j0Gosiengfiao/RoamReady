<section class="about-area section--padding overflow-hidden" id="about-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="about-content pb-5">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title">Why QNect Started?</h2>
                    ...
                    <div class="row pt-4 pb-3">
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                ...
                                <h4 class="fs-20 font-weight-semi-bold pt-3">Personalized Itinerary</h4>
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                ...
                                <h4 class="fs-20 font-weight-semi-bold pt-3">Accessible Exploration</h4>
                            </div><!-- end info-icon-box -->
                        </div><!-- end col-lg-4 -->
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                ...
                                <h4 class="fs-20 font-weight-semi-bold pt-3">Trusted Reviews</h4>
                            </div><!-- end info-icon-box -->
                        </div><!-- end col-lg-4 -->
                    </div><!-- end row -->
