...
<ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
    ...
    <li class="{{ $currentRoute == 'user.qnect.activities' || $currentRoute == 'user.qnect.activities.create' ? 'page-active' : '' }}"><a href="{{ route('user.qnect.activities') }}"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px">
