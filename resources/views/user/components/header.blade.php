<header class="header-menu-area">
                        ...
                        <div class="menu-wrapper">
                            ...
                            <div class="nav-right-button d-flex align-items-center">
                                <div class="user-action-wrap d-flex align-items-center">
                                                    ...
                                                    <li>
                                                        <div class="media media-card">
                                                            <a href="course-details.html" class="media-img">
                                                                <img class="mr-3" src="images/small-img.jpg" alt="">
                                                            </a>
                                                            <div class="media-body">
                                                                ...
                                                                <p class="text-black font-weight-semi-bold lh-18">
                                                                    $12.99 <span class="before-price fs-14">Price here</span></p>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="shop-cart notification-cart pr-3 mr-3">
                                        <ul>
                                            <li>
                                                <p class="shop-cart-btn">
                                                ...
                                                <ul class="cart-dropdown-menu after-none p-0 notification-dropdown-menu">
                                                        ...
                                                        <div class="notification-body">
                                                            ...
                                                            <a href="dashboard.html" class="media media-card align-items-center">
                                                                ...
                                                                <div class="media-body">
                                                                    ...
                                                                    <span class="d-block lh-18 pt-1 text-gray fs-13">November
                                                                        12, 2019</span>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    ...
                                                    <li class="menu-heading-block">
                                                        <a href="dashboard.html" class="btn theme-btn w-100">Show All
                                                            Notifications <i class="la la-arrow-right icon ml-1"></i></a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shop-cart-btn">
                                                    <div class="avatar-xs">
                                                        <img class="rounded-full img-fluid" src="{{ asset('/landing/images/small-avatar-1.jpg') }}" alt="A">
                                                    </div>
    ...
    <div class="off-canvas-menu custom-scrollbar-styled main-off-canvas-menu">
        <div class="off-canvas-menu-close main-menu-close icon-element icon-element-sm" data-toggle="tooltip" data-placement="left" title="Close menu">
