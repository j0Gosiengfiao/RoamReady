    ...
    <div class="card-body">
        ...
        <ul class="card-duration d-flex align-items-center card-text pb-2">
            <li class="mr-2">
                ...
                <span class="badge badge-success text-white">{{ $item->activity_age_limit == 1 ? 'All ages' : 'Adults only' }}</span>
            </li>
            <li class="mr-2">
                <span class="text-black">Start of Operation:</span>
                <span>{{ date('h:i A', strtotime($item->activity_start)) }}</span>
            </li>
            <li class="mr-2">
                <span class="text-black">End of Operation:</span>
                <span>{{ date('h:i A', strtotime($item->activity_end)) }}</span>
            </li>
        </ul>
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="card-action-wrap pl-3">
                ...
                <a href="{{ route('user.qnect.activities.destroy', ['activity' => $item->id]) }}" class="icon-element icon-element-sm cursor-pointer ml-1 text-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
